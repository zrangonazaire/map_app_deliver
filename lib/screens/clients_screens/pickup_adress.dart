import 'package:map_app_deliver/screens/clients_screens/drop_adress.dart';
import 'package:map_app_deliver/screens/clients_screens/login/creer_compte.dart';

import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class PickUpAdress extends StatefulWidget {
  const PickUpAdress({Key? key}) : super(key: key);

  @override
  _PickUpAdressState createState() => _PickUpAdressState();
}

class _PickUpAdressState extends State<PickUpAdress> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Adress de recupération du colis"),
        ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const SizeBoxTextFiel(
                      ...
                      label: "Quartier de récupération du colis",
